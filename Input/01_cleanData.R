...
## Also, I found there are some missing data for Number of people got affected. 
...
## Since I want to fit linear regression model in the second script, 
## it is necessary to make sure all countries having multiple observations. 
## I will delete the countries with only 2 or less observations.
